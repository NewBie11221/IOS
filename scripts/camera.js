...
////////callbacks
	...
	if(elem.length!=0){
		...
		$('.moveFromLeft, .moveFromRight, .moveFromTop, .moveFromBottom, .fadeIn, .fadeFromLeft, .fadeFromRight, .fadeFromTop, .fadeFromBottom1',fakeHover).each(function(){
			...
			$.each(arr, function(index, value) {
				...
				function cameraeased() {
					...
					if($('.cameraeased',target).length==blocks){
						...
						var lMoveInContent = $('.cameraContent',fakeHover).eq(slideI).find('.moveFromLeft, .moveFromRight, .moveFromTop, .moveFromBottom, .fadeIn, .fadeFromLeft, .fadeFromRight, .fadeFromTop, .fadeFromBottom1').length;
						...
						if (lMoveInContent!=0){
							...
							$('.cameraContent.cameracurrent .moveFromLeft, .cameraContent.cameracurrent .moveFromRight, .cameraContent.cameracurrent .moveFromTop, .cameraContent.cameracurrent .moveFromBottom, .cameraContent.cameracurrent .fadeIn, .cameraContent.cameracurrent .fadeFromLeft, .cameraContent.cameracurrent .fadeFromRight, .cameraContent.cameracurrent .fadeFromTop, .cameraContent.cameracurrent .fadeFromBottom1',fakeHover).each(function(){
								...
								} else if(tClass.indexOf("fadeFromBottom1") != -1) {
